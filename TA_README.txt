...
10-08-2022  SOLVE 1 ERROR (dates on X-axis)
10-09-2022  SOLVE 2 ERRORS (REMOVE VERTICAL LINE FOR INDEX 0 / MARK THE MAX & MIN VALUE OF EACH COLUMNS IN SAME WAY)
10-10-2022  SOLVE 1 ERROR (COLUMNS-OVERLAPSE)
            CODE(USING EXCEL-files) HAS BEEN COMPLETED
10-15-2022  START TO LEARN "PyQt" TO GET READY FOR USING "OpenAPI"